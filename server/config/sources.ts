...
export const SOURCES: NewsSource[] = [
  ...
  },
  {
    ...
    topicIds: ['ai', 'cloud', 'security', 'devops', 'programming', 'ai-research', 'ai-companies'],
    reliability: 0.88,
    maxItemsPerFetch: 25,
  },
  {

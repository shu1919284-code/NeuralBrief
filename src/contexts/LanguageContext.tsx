...
const en: TranslationMap = {
  ...
  'topic_data_science_desc': 'Statistics, data analysis, and visualization',
  'topic_machine_learning_label': 'Machine Learning',
  'topic_machine_learning_desc': 'ML algorithms, models, and frameworks',
  'topic_ai_research_label': 'AI Research',
  'topic_ai_research_desc': 'Latest papers and breakthroughs',
  'topic_agentic_ai_label': 'Agentic AI',
  'topic_agentic_ai_desc': 'AI agents, automation, and orchestration',
  'topic_mlops_label': 'MLOps',
  'topic_mlops_desc': 'ML deployment, monitoring, and pipelines',
  'topic_model_releases_label': 'Model Releases',
  'topic_model_releases_desc': 'New AI model launches and updates',
  'topic_ai_industry_label': 'AI Industry',
  'topic_ai_industry_desc': 'Business news, funding, and trends',
  'topic_tools_libraries_label': 'Tools & Libraries',
  'topic_tools_libraries_desc': 'Developer tools, SDKs, and frameworks',
